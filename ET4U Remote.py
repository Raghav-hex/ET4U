...
def get_db_connection():
    return ms.connect(host='sql12.freesqldatabase.com', user='sql12750619', passwd='MLCVxErTRF', database='sql12750619')
...
def Signup():
    ...
    def Submit_Signup():
        ...
        P=Passwd_input.get()
        ST=Stud_Teach.get()
        con=ms.connect(host='sql12.freesqldatabase.com',user='sql12750619',passwd='MLCVxErTRF',database="sql12750619")
        cur=con.cursor()
...
def Teach_Win():
    ...
    def Trip_up():
        ...
        def display_output(amenities):
            ...
            output_window.iconbitmap('ET4Uicon.ico')
        ...
        input_window.iconbitmap('ET4Uicon.ico')
